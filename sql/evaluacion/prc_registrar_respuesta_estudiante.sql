...
BEGIN
  INSERT INTO respuesta_estudiante (
    ...
    p_evaluacion_id, p_estudiante_id, p_pregunta_id, p_curso_id,
    p_respuesta_texto, p_respuesta_opcion_id, p_respuesta_compuesta,
    p_es_correcta, CURRENT_TIMESTAMP
  );

  prc_actualizar_tasa(p_pregunta_id); -- ya la tenemos
END;
/
